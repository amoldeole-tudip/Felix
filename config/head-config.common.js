...
module.exports = {
  ...
  //   { rel: 'icon', type: 'image/icon', sizes: '32x32', href: '/assets/icon/favicon-32x32.png' },
  //   { rel: 'icon', type: 'image/icon', sizes: '96x96', href: '/assets/icon/favicon-96x96.png' },
  //   { rel: 'icon', type: 'image/icon', sizes: '16x16', href: '/assets/icon/favicon-16x16.png' }
