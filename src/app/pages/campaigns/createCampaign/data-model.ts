...
export const dropdownAttribute = ['Attribute1', 'Attribute2', 'Attribute3', 'Attribute4'];

export const attributevalues = ['Value1', 'Value2', 'Attribute Value3', 'Attribute Value4'];
